...
var    createText = function(game) {
    ...
    createGround = function(game) {
        ...
        setTileMap.layer2.setCollisionBetween(10, 36);
        ...
        setTileMap.layer1.setTileIndexCallback([2, 3], this.getDamage, this);
        setTileMap.layer1.setTileIndexCallback(19, this.getDamage, this);
...
level1.prototype = {
    preload: function() {
        ...
        this.game.load.tilemap('level1_1', 'game/levels/level1/level1_1.csv', null, Phaser.Tilemap.CSV);
        this.game.load.tilemap('level1_2', 'game/levels/level1/level1_2.csv', null, Phaser.Tilemap.CSV);
    },
    ...
    create: function(game) {
        ...
        this.createBlueEnemy(this.game, 1200, 400, 1000);
        this.createBlueEnemy(this.game, 1600, 300, 2000);
        this.createBlueEnemy(this.game, 2000, 250, 1000);

        this.createLives(this.game);
        this.createAmountBalls(this.game, 1);
