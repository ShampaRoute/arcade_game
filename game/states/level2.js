...
level2.prototype = {
    preload: function() {
        ...
        this.game.load.tilemap('level1_1', 'game/levels/level2/lev_1.csv', null, Phaser.Tilemap.CSV);
        this.game.load.tilemap('level1_2', 'game/levels/level2/lev_2.csv', null, Phaser.Tilemap.CSV);
    },

    create: function(game) {
        console.log('%cSTATE::LEVEL 2', 'color: #fff; background: #f0f;');
        health = 100;
        balls = null;
        playerX = 50;
        playerY = 400;
        ...
        this.createBlueEnemy(this.game, 400, 400, 700);
        this.createBlueEnemy(this.game, 550, 400, 600);
        this.createBlueEnemy(this.game, 800, 300, 2000);
        this.createBlueEnemy(this.game, 1150, 300, 1000);
        this.createBlueEnemy(this.game, 1300, 200, 500);
        this.createBlueEnemy(this.game, 1600, 250, 1000);
        this.createBlueEnemy(this.game, 1750, 400, 600);
        this.createBlueEnemy(this.game, 2000, 400, 700);
        this.createBlueEnemy(this.game, 2200, 300, 600);
