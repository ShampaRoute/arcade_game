...
preload.prototype = {
    preload: function() {
        ...
        this.game.load.audio('music', 'game/audio/menuMusic.ogg');
        this.game.load.image('X', 'game/objects/X.png');
        this.game.load.image('buttonSound', 'game/objects/buttonSound.png');
